...
library(ggrepel)
library(plotrix)
>>>>>>> 94b9b9bfb1d06ec3001e21cc24e7571a2d9aa06d
library(quantmod)
library(tseries)
library(gridExtra)
library(patchwork)
...
=======
  labs(title = "Gráfico 2 - Desempleo femenino y masculino, con educación terciaria, por año", x = "Año", y = "Distribución (%)") +
...
=======
  labs(title = "Gráfico 3 - Distribución del empleo por tipo de actividad y género", x = "Tipo de Actividad", y = "Distribución (%)")
>>>>>>> 94b9b9bfb1d06ec3001e21cc24e7571a2d9aa06d
...
G6 <-empleadores %>% 
  ...
  scale_color_manual(labels= c("Hombres","Mujeres"), values = c("#213A40", "#D9325E"))+
  labs(title = "Gráfico 6 - Empleadores por género y año", x = "Años", y = "Porcentaje", color = "Sexo")+
  scale_x_continuous(limits=c(1990,2018),breaks = c(1990,1995,2000,2005,2009,2013,2018)) +
  theme_classic()+
  theme(axis.text.x = element_text(size = 9),  
        axis.text.y = element_text(size = 9),
...
G7 <- boxplot(Jefes_vs_desempleocal$porcentaje ~ Jefes_vs_desempleocal$variable,
        horizontal = TRUE,
        col = c("#8FBC8F","#DDA0DD", "#00FFFF", "#F4A460"), 
        outbg = "black", 
        outpch = 23,
        ylab = "",
        xlab = "Porcentaje",
...
legend(8, 4, c("Desemplao Calificado Hombres", "Desemplao Calificado Mujeres", "Jefas", "Jefes"),
       fill = c("#8FBC8F","#DDA0DD", "#00FFFF", "#F4A460"))
