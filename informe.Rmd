...
```{r  collapse=TRUE, warning=FALSE, fig.align='center'}
str(desempleo)
...
```{r fig.width=15, fig.height=8, collapse=TRUE, warning=FALSE}
G1_1 / (G1_2 + G1_3) 
...
```{r fig.align='center', collapse=TRUE, warning=FALSE}
# Comparación del desempleo por género, filtro variable por desempleo y agrego columna con el sexo
...
```{r, fig.width=10, fig.height=5, fig.align='center', collapse=TRUE, warning=FALSE}
...
```{r collapse=TRUE, warning=FALSE, cache=FALSE, message=FALSE, fig.align='center'}
...
G6
```
Lo que es notable de este gráfico además de la diferencia promedio es la tasa a la baja del porcentaje de empleadores mientras que el porcentaje de empleadoras está constante. ¿Eso por qué será? ¿Esto es el porcentaje de hombres que son empleadores o el porcentaje de empleadores y empleadoras que son hombres?
...
```{r, fig.width=10, fig.height=4, fig.align='center', collapse=TRUE, warning=FALSE}
...
```{r collapse=TRUE, warning=FALSE, fig.width=10, fig.height=4, fig.align='center'}
...
En el gráfico 8 podemos tenemos la distribución de las actividades femenina, donde podemos apreciar que en gran porcentaje las mujeres realizan trabajo parcial, informal o trabajo doméstico lo que implica menos ingresos y nos preguntamos ¿Los trabajos domésticos, le restan tiempo a las mujeres para realizar trabajo remunerado?
