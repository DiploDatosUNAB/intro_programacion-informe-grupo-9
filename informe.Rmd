...
G6
```
Este gráfico muestra algo bastante particular, y es que, mientras el porcentaje promedio de empleadores tiene una clara caída con una pendiente bien marcada, el porcentaje de empleadoras se mantiene bastante estable a través de los años observados, a pesar de mostrar una inflexión similar entre los años 2005 y 2007 aproximadamente.
>>>>>>> 8a96a21cb5f6173bfc63a12494b48cb5d93cdb42
...
<<<<<<< HEAD
A continuación podemos ver las tablas con las medias de la distribución por tipo de empleo, tanto para hombres como para mujeres y uno de los datos que nos muestra la siguiente tabla es que el empleo parcial de mujeres la media llega casi al 60 y en los hombres no hay dato alguno. 
=======
A continuación podemos ver las tablas con las medias de la distribución por tipo de empleo, tanto para hombres como para mujeres:
>>>>>>> 8a96a21cb5f6173bfc63a12494b48cb5d93cdb42
