...
Los datos utilizados en este informe fueron tomados por el Banco Mundial sobre empleo/desempleo y género para algunos países de Latinoamérica y el Caribe, entre los años 1970 y 2018. Estos datos fueron provistos en formato de <em>data-frame</em> y contienen una cantidad de variables que aportan datos sobre el empleo/desempleo, tipo de empleo/actividad y legislación.
...
Desempleo es una tabla de 4 variables y 74 observaciones. Deriva de la tabla empleo_Arg, y presenta sólo los datos de desempleo.
...
```{r}
ggplot(desempleo,aes(Anio,porcentaje, fill = sexo)) + geom_col(stat = "Identity",position=position_dodge()) + labs(title = "Gráfico 1 - Desempleo femenino y masculino por año")
```
```{r}
...
A lo largo de los años, este comportamiento se mantiene, registrándose una diferencia importante entre los porcentajes de desempleo. Incluso cuando se trata de hombres y mujeres con educacion terciaria, las diferencias siguen ahí.
