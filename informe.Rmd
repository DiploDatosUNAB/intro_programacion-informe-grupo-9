...
Intentaremos contestar a continuación, alguna de estas preguntas.

### ¿Existe una brecha de desempleo de acuerdo al género de las personas?
...
### ¿Las mujeres con el mismo nivel académico que los hombres tienen las mismas oportunidades de ocupar un puesto jerárquico?, ¿y cuando hablamos de cargos jerárquicos?
...
### ¿qué tanta diferencia hay entre los ingresos de los hombres y de las mujeres?
...
### ¿Los trabajos domésticos, le restan tiempo a las mujeres para realizar trabajo remunerado?
...
actividades_mujeres <- empleo_Arg |> 
  mutate(sexo = ifelse(str_detect(variable,"mujeres"),"Mujer","Hombre")) |> 
  filter(sexo == "Mujer") |> 
  filter(variable != c("desempleo_mujeres","desempleo_educacion_mujeres8") |> 
  group_by(variable) |> 
  summarise(media = mean(porcentaje,na.rm = TRUE))

head(actividades_mujeres,10)

ggplot(actividades_mujeres, aes(media, variable, fill = variable)) +
  geom_col(position=position_dodge()) +
  labs(title = "Gráfico xxx - Distribución de actividad y género")
```



### ¿Está asociado el trabajo doméstico con el trabajo informal?


### ¿Las mujeres pueden desarrollarse en cualquier tipo de empleo o el sistema las condiciona a realizar determinadas tareas?
